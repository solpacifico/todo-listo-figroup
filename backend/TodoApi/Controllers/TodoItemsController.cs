    ...
    public class TodoItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<TodoItem>>> GetTodoItemsT()
        {
          if (_context.TodoItemsT == null)
          {
            ...
            return await _context.TodoItemsT.ToListAsync();
        }
        ...
        public async Task<ActionResult<TodoItem>> PostTodoItem(TodoItem todoItem)
        {
          if (_context.TodoItemsT == null)
          {
              return Problem("Entity set 'DataContext.TodoItemsT'  is null.");
          }
            _context.TodoItemsT.Add(todoItem);
            await _context.SaveChangesAsync();
        ...
        {
            return (_context.TodoItemsT?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
